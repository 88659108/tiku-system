var app_paper_time 	= (function($){
	...
	function __usetime_format(usetime, _config){
		...
		return  _config.msgstr + window.timeFormat(_usetime, _config.format);
	}
	...
	function __start_usetime(off){
		...
		_objects.int_papertime	= setInterval(function(){
			...
			var title			= '还剩余：' + timeFormat((Number(obj_usetime.attr('totaltime')) - usetime));
