var app_paper_question 	= (function($){
	...
	function __usetime_format(usetime){
		...
		return '用时：' + window.timeFormat(_usetime, 'mm分ss秒');
	}
	...
	function __init(){
		...
		//暂停计时	
		}).mouseleave(function(){ clearInterval(_objects.int_usetime); });
		...
		_questions.find(_objects.obj._options).click(function(){
			...
			if(_objects.pagetype == 1){
				...
				clearInterval(_objects.int_usetime);
