 ...
 * paper.icos.js
 * 	
 * 题库模块[答题卡] v1.0 | @zhongmin | | 2015-12-04
...
;(function($, window, undefined){
	...
	function __ajax(config, callback, error){
		...
		_utils.ajax.post(url, {paperid:config.paperid, getinfo:1}, function(json){
