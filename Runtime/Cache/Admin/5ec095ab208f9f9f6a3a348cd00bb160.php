...
<li>教学内容</li>
<li><a href="/index.php/Admin/Question/objective">资料题</a></li>
    ...
    <div class="col-xs-12">
      <div class="tabbable">
        <ul class="nav nav-tabs" id="myTab">
          ...
          <li class="question-form"<?php if($minfo["id"] == 0): ?>style="display:none;"<?php endif; ?>> <a data-toggle="tab" href="#question-form"> <i class="green icon-edit bigger-110"></i> 添加子题 </a> </li>
          <li class="dropdown dropdown-list"<?php if($minfo["id"] == 0): ?>style="display:none;"<?php endif; ?>><a data-toggle="dropdown" class="dropdown-toggle" href="#"> 子题列表 <span class="badge badge-danger js-item-count"><?php echo ($minfo["qnums"]); ?></span> &nbsp; <i class="icon-caret-down bigger-110 width-auto"></i> </a>
            <ul class="dropdown-menu dropdown-info">
              <?php if(is_array($minfo["items"])): $k = 0; $__LIST__ = $minfo["items"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cls): $mod = ($k % 2 );++$k;?><li> <a data-toggle="tab" href="#question-item-<?php echo ($k); ?>">第<?php echo ($k); ?>题</a></li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
          </li>
          
          <li class="question-form-edit" style="display:none;"> <a href="/index.php/Admin/Question/material_form?id=xxx" target="_blank"> <i class="green icon-external-link bigger-110"></i> 修改试题 </a> </li>
        ...
        <div class="tab-content">
          ...
          <form>
  			<?php if($minfo["id"] != 0): ?><input type="hidden" value="<?php echo ($minfo["id"]); ?>" name="id" /><?php endif; ?>
            <script type="text/plain" id="material-<?php echo ($minfo["id"]); ?>">
			<?php if($minfo["material"] != ''): echo (htmlspecialchars_decode($minfo["material"])); else: ?>试题题干（图文并茂）<?php endif; ?>
            </script>
            <script>
			ueditor_config.textarea	= 'material';
			var ue = UE.getEditor('material-<?php echo ($minfo["id"]); ?>', ueditor_config);
            </script>
            <br />
                ...
                <div class="row">
                  <div class="col-xs-3">
                    <select class="form-control" name="ismock">
                      <option value="<?php echo ($minfo["ismock"]); ?>">真题 或 模拟...</option>
                      <option value="1"
                      <?php if(($minfo["ismock"]) == "1"): ?>selected="selected"<?php endif; ?>
                      >真题
                      </option>
                      <option value="0"
                      <?php if(($minfo["ismock"]) == "0"): ?>selected="selected"<?php endif; ?>
                      >模拟
                      </option>
                    </select>
                  </div>
                  <div class="col-xs-3">
                    <select class="form-control" name="bigtype">
                      ...
                      <?php if(is_array($minfo["form_list1"])): $i = 0; $__LIST__ = $minfo["form_list1"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cls): $mod = ($i % 2 );++$i;?><option 
                        <?php if(($minfo["bigtype"]) == $cls["id"]): ?>selected="selected"<?php endif; ?> 
                  ...
                  <div class="col-xs-3">
                    <select class="form-control" name="smalltype">
                      ...
                      <?php if(is_array($minfo["form_list2"])): $i = 0; $__LIST__ = $minfo["form_list2"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cls): $mod = ($i % 2 );++$i; if(is_array($cls['list'])): $i = 0; $__LIST__ = $cls['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$clss): $mod = ($i % 2 );++$i;?><option value="<?php echo ($clss["id"]); ?>"
                          <?php if(($minfo["smalltype"]) == $clss["id"]): ?>selected="selected"<?php endif; ?>
                          >&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($clss["title"]); ?>
                  ...
                  <div class="col-xs-3">
                    <select class="form-control" name="pointtype">
                      ...
                      <?php if(is_array($minfo["form_list3"])): $i = 0; $__LIST__ = $minfo["form_list3"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cls): $mod = ($i % 2 );++$i; if(is_array($cls['list'])): $i = 0; $__LIST__ = $cls['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$clss): $mod = ($i % 2 );++$i;?><option value="<?php echo ($clss["id"]); ?>"
                          <?php if(($minfo["pointtype"]) == $clss["id"]): ?>selected="selected"<?php endif; ?>
                          >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($clss["title"]); ?>
                          </option><?php endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                  </div>
                ...
                <div class="row">
                  <div class="col-xs-3">
                    <div class="input-group"> <span class="input-group-addon"><i class="">年份</i></span>
                      <input class="form-control" value="<?php echo ($minfo["qyear"]); ?>" name="qyear" type="text" placeholder="如：2013">
                    </div>
                  </div>
                  <div class="col-xs-3">
                    <div class="input-group"> <span class="input-group-addon"><i class="">难度(0-5)</i></span>
                      <input class="form-control" value="<?php echo ($minfo["diff"]); ?>" name="diff" type="text" placeholder="(0-5)">
                    </div>
                  </div>
                  <div class="col-xs-3">
                    <div class="input-group"> <span class="input-group-addon"><i class="">考频(0-5)</i></span>
                      <input class="form-control" value="<?php echo ($minfo["chance"]); ?>" name="chance" type="text" placeholder="(0-5)">
                    </div>
                  </div>
                  <div class="col-xs-3">
                    <div class="input-group"> <span class="input-group-addon"><i class="">状态</i></span>
                      <input class="form-control" value="<?php echo ($minfo["status"]); ?>" name="status" type="text" placeholder="(0-1)">
                    </div>
                  </div>
                </div>
              </div>
		  ...
		  <div id="question-form" class="tab-pane">
			...
			<form>
  			<input type="hidden" value="<?php echo ($minfo["id"]); ?>" name="materialid" />
            <script type="text/plain" id="body-<?php echo ($minfo["id"]); ?>">
			试题题干（图文并茂）
            </script>
            <script>
			ueditor_config.textarea	= 'body';
			var ue = UE.getEditor('body-<?php echo ($minfo["id"]); ?>', ueditor_config);
            </script>
            <br />
            <div class="widget-box transparent">
              <div class="widget-header widget-header-flat">
            ...
            <div class="widget-box transparent">
              ...
              <div class="widget-body"> 
                <script type="text/plain" id="description-<?php echo ($minfo["id"]); ?>">试题解析（图文并茂）</script>
				<script>
				ueditor_config.textarea	= 'description';
				var ue = UE.getEditor('description-<?php echo ($minfo["id"]); ?>', ueditor_config);
                </script>
              </div>
            </div>
            <br />
          ...
          <?php if(is_array($minfo["items"])): $k = 0; $__LIST__ = $minfo["items"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($k % 2 );++$k;?><div id="question-item-<?php echo ($k); ?>" class="tab-pane">
...
$('.js-btn-form-material-submit').click(function(){
	...
	var data	= oform.serialize();
	ajaxSend('/index.php/Admin/Question/material_save', data, function(json){
